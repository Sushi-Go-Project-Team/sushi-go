...
<p>Keep track of your scores from the previous round. A new round will begin and all the cards will be discarded. The only exceptions are Mochi cards which you keep in front of you to be scored at the end of the game. Every player will be handed 6 cards, equal to the amount from the last round.
            ...
            <img src={"images/card-soy-sauce-egg.jpg"} border = "3" height = "30%" width = "30%"/>
            ...
            <img src={"images/card-bok-choy.jpg"} border = "3" height = "30%" width = "30%"/>
            ...
            <img src={"images/card-narutomaki-1.jpg"} border = "3" height = "30%" width = "30%"/>
            <img src={"images/card-narutomaki-2.jpg"} border = "3" height = "30%" width = "30%"/>
            <img src={"images/card-narutomaki-3.jpg"} border = "3" height = "30%" width = "30%"/>
            ...
            <img src={"images/card-mochi.jpg"} border = "3" height = "30%" width = "30%"/>
            ...
            <Button className = "instructions-button"><Link to="/join" className = "button--link">Join A Game</Link></Button>
